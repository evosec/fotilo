...
public class ShowThumbnailTask extends AsyncTask<Uri, Void, Bitmap> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ShowThumbnailTask.class);
    private static final int THUMBNAIL_SIZE = 100;

    private ContentResolver contentResolver;
    private ImageButton pictureReview;

    public ShowThumbnailTask(ImageButton imageButton, ContentResolver contentResolver) {
